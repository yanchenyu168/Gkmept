...
public class OpenFile {
    //region android获取一个用于打开HTML文件的intent
    ...
    //endregion
    //region android获取一个用于打开图片文件的intent
    /**
     *
     * @param Path
     * @return
    ...
    //endregion
    //region android获取一个用于打开PDF文件的intent
    ...
    //endregion
    //region android获取一个用于打开文本文件的intent
    ...
    //endregion
    //region android获取一个用于打开音频文件的intent
    ...
    //endregion
    //region android获取一个用于打开视频文件的intent
    ...
    //endregion
    //region android获取一个用于打开CHM文件的intent
    ...
    //endregion
    //region android获取一个用于打开Word文件的intent
    ...
    //endregion
    //region android获取一个用于打开Excel文件的intent
    ...
    //endregion
    //region android获取一个用于打开PPT文件的intent
    ...
    //endregion
    //region android获取一个用于打开apk文件的intent
